        ...
        <div className="p-6 sm:p-10">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
                ...
                <div className="flex gap-4">
                    <button onClick={()=> window.open('https://github.com/ryanvp10/recibot-app','_blank')}  className="cursor-pointer flex items-center gap-2 text-sm font-medium text-gray-300 hover:text-primary-400 transition-colors border border-gray-700 rounded-full px-4 py-2 hover:bg-gray-800">
